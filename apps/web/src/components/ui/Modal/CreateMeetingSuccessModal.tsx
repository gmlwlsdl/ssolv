...
const CreateMeetingSuccessModal = ({ isOpen, onClose }: CreateMeetingSuccessModalProps) => {
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} showCloseButton className="max-w-[335px] pt-4">
      <div className="flex flex-col items-center pb-9 select-none">
        <Image
          src="/images/modal/modal-success.svg"
          alt="모임 생성 완료 아이콘"
          width={100}
          height={100}
        />
        <div className="flex flex-col items-center gap-2 pt-2 pb-4">
          <h3 className="type-gradient heading-3 font-bold">모임이 생성되었어요!</h3>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex w-23 cursor-pointer flex-col items-center gap-3 py-3 transition-opacity hover:opacity-70"
          >
            <Image src="/images/brand/kakaotalk.svg" alt="카카오톡 아이콘" width={52} height={52} />
            <div className="text-center label-1 text-neutral-1000">카카오톡</div>
          </button>
          <button
          ...
          >
            ...
            <div className="text-center label-1 text-neutral-1000">URL 복사</div>
          </button>
        </div>
      </div>
    </BaseModal>
