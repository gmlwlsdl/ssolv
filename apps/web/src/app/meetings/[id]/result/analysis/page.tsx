...
import MenuPreferenceList from '@/app/meetings/[id]/result/analysis/_components/MenuPreferenceList';
import PieChart from '@/app/meetings/[id]/result/analysis/_components/PieChart';
import RestaurantCardSwiper from '@/app/meetings/[id]/result/analysis/_components/RestaurantCardSwiper';
...
const AnalysisPage = async ({ params }: AnalysisPageProps) => {
  ...
  const overview = queryClient.getQueryData<MeetingOverview>(
    getOverviewQueryOptions(Number(id)).queryKey
  );
