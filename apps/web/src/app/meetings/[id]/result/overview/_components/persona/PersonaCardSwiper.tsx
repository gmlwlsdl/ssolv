...
import PersonaCard from '@/app/meetings/[id]/result/overview/_components/persona/PersonaCard';
import PersonaEmptyCard from '@/app/meetings/[id]/result/overview/_components/persona/PersonaEmptyCard';
