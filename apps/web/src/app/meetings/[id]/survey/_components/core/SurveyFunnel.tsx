...
import SurveyLayout from '@/app/meetings/[id]/survey/_components/core/SurveyLayout';
import SurveyCuisineStep from '@/app/meetings/[id]/survey/_components/step/SurveyCuisineStep';
import SurveyProfileStep from '@/app/meetings/[id]/survey/_components/step/SurveyProfileStep';
import ConfirmModal from '@/app/meetings/[id]/survey/_components/ui/modal/ConfirmModal';
import { useSurveyFunnel } from '@/app/meetings/[id]/survey/_hooks/useSurveyFunnel';
import { getPrevStepKey, SURVEY_TOTAL_STEPS } from '@/app/meetings/[id]/survey/_models/constants';
import { surveyApi } from '@/services/survey/api';

import type { RoleLabel, SurveyResult } from '@/app/meetings/[id]/survey/_models/types';
...
const SurveyFunnel = ({ role, meetingId, initial, onComplete: _onComplete }: SurveyFunnelProps) => {
  ...
  const handleBack = () => {
    if (step === 'PreferCuisine') return router.push(`/meetings/${meetingId}/result/overview`);
      ...
      return (
        ...
        >
          ...
          <ConfirmModal
            ...
            onConfirm={() => {
              closeModal();
              router.push(`/meetings/${meetingId}/result/overview`);
            }}
          />
